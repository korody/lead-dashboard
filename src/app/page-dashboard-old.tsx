    ...
    <div className="w-full min-h-screen transition-all duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <AnimatedStatCard
            ...
            subtitle={`Quiz completado${selectedDays < 9999 ? ` (${selectedDays}d)` : ''}`}
            format="number"
            delay={0.1}
          />
          ...
          <div onClick={() => window.location.href = '/leads?vip=true'} className="cursor-pointer">
            <AnimatedStatCard
              ...
              subtitle={`Score alto${selectedDays < 9999 ? ` (${selectedDays}d)` : ''}`}
              format="number"
              delay={0.2}
            />
          </div>
        ...
        {/* Comparação Temporal - Collapsible - Oculto quando "Todo o Tempo" */}
        {selectedDays < 9999 && (
          <motion.div
